...
function NgbDatepicker_ng_template_0_Template(rf, ctx) { if (rf & 1) {
    ...
    const date_r39 = ctx.date;
    const currentMonth_r40 = ctx.currentMonth;
    const selected_r41 = ctx.selected;
    const disabled_r42 = ctx.disabled;
    const focused_r43 = ctx.focused;
...
function NgbDatepicker_ng_template_2_div_0_div_1_Template(rf, ctx) { if (rf & 1) {
    ...
    const month_r45 = ɵngcc0.ɵɵnextContext().$implicit;
...
function NgbDatepicker_ngb_datepicker_navigation_5_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("navigate", function NgbDatepicker_ngb_datepicker_navigation_5_Template_ngb_datepicker_navigation_navigate_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r50); const ctx_r49 = ɵngcc0.ɵɵnextContext(); return ctx_r49.onNavigateEvent($event); })("select", function NgbDatepicker_ngb_datepicker_navigation_5_Template_ngb_datepicker_navigation_select_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r50); const ctx_r51 = ɵngcc0.ɵɵnextContext(); return ctx_r51.onNavigateDateSelect($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
