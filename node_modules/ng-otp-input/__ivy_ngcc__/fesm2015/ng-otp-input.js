...
function NgOtpInputComponent_div_0_input_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("keydown", function NgOtpInputComponent_div_0_input_1_Template_input_keydown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r71); const ctx_r70 = ɵngcc0.ɵɵnextContext(2); return ctx_r70.onKeyDown($event); })("keyup", function NgOtpInputComponent_div_0_input_1_Template_input_keyup_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r71); const i_r69 = ctx.index; const ctx_r72 = ɵngcc0.ɵɵnextContext(2); return ctx_r72.onKeyUp($event, i_r69); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const item_r68 = ctx.$implicit;
    const i_r69 = ctx.index;
    const ctx_r67 = ɵngcc0.ɵɵnextContext(2);
    ɵngcc0.ɵɵclassMapInterpolate1("otp-input ", ctx_r67.config.inputClass, "");
    ɵngcc0.ɵɵpropertyInterpolate2("id", "otp_", i_r69, "_", ctx_r67.componentKey, "");
    ɵngcc0.ɵɵproperty("pattern", ctx_r67.config.allowNumbersOnly ? "\\d*" : "")("type", ctx_r67.inputType)("placeholder", (ctx_r67.config == null ? null : ctx_r67.config.placeholder) || "")("disabledNumberOnly", !ctx_r67.config.allowNumbersOnly)("ngStyle", ctx_r67.config.inputStyles)("formControl", ctx_r67.otpForm.controls[item_r68]);
} }
function NgOtpInputComponent_div_0_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵclassMapInterpolate1("wrapper ", ctx_r66.config.containerClass, "");
    ɵngcc0.ɵɵpropertyInterpolate1("id", "c_", ctx_r66.componentKey, "");
    ɵngcc0.ɵɵproperty("ngStyle", ctx_r66.config.containerStyles);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngForOf", ɵngcc0.ɵɵpipeBind1(2, 6, ctx_r66.otpForm == null ? null : ctx_r66.otpForm.controls));
} }
class KeysPipe {
    /**
     * @param {?} value
