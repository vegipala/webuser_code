...
function NgOtpInputComponent_div_0_input_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("keydown", function NgOtpInputComponent_div_0_input_1_Template_input_keydown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r33); var ctx_r32 = ɵngcc0.ɵɵnextContext(2); return ctx_r32.onKeyDown($event); })("keyup", function NgOtpInputComponent_div_0_input_1_Template_input_keyup_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r33); var i_r31 = ctx.index; var ctx_r34 = ɵngcc0.ɵɵnextContext(2); return ctx_r34.onKeyUp($event, i_r31); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    var item_r30 = ctx.$implicit;
    var i_r31 = ctx.index;
    var ctx_r29 = ɵngcc0.ɵɵnextContext(2);
    ɵngcc0.ɵɵclassMapInterpolate1("otp-input ", ctx_r29.config.inputClass, "");
    ɵngcc0.ɵɵpropertyInterpolate2("id", "otp_", i_r31, "_", ctx_r29.componentKey, "");
    ɵngcc0.ɵɵproperty("pattern", ctx_r29.config.allowNumbersOnly ? "\\d*" : "")("type", ctx_r29.inputType)("placeholder", (ctx_r29.config == null ? null : ctx_r29.config.placeholder) || "")("disabledNumberOnly", !ctx_r29.config.allowNumbersOnly)("ngStyle", ctx_r29.config.inputStyles)("formControl", ctx_r29.otpForm.controls[item_r30]);
} }
function NgOtpInputComponent_div_0_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵclassMapInterpolate1("wrapper ", ctx_r28.config.containerClass, "");
    ɵngcc0.ɵɵpropertyInterpolate1("id", "c_", ctx_r28.componentKey, "");
    ɵngcc0.ɵɵproperty("ngStyle", ctx_r28.config.containerStyles);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngForOf", ɵngcc0.ɵɵpipeBind1(2, 6, ctx_r28.otpForm == null ? null : ctx_r28.otpForm.controls));
} }
'use strict';
