...
export class CartService {
  ...
  calcuate() {
    ...
    this.cart.forEach(element => {
      ...
      this.orderTax = total * (0.12)
      this.orderTax = this.orderTax.toFixed(2)
    });

    this.totalPrice = total;

    // This is tax addition of 12% on each product
    // this.orderTax = this.totalPrice * (this.orderTax/100)
    // this.orderTax = this.orderTax.toFixed(2)
